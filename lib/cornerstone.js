...
(function (cornerstone) {
    ...
    function fitToWindow(element)
    {
        var enabledElement = cornerstone.getEnabledElement(element);
        enabledElement.layers.forEach(function(layer) {
            var defaultViewport = cornerstone.internal.getDefaultViewport(layer.canvas, enabledElement.image);
...
(function ($, cornerstone) {
    ...
    function drawImage(enabledElement, invalidated) {
        ...
        var start = new Date();
        enabledElement.layers.forEach(function(layer) {
            enabledElement.image.render(enabledElement, layer, invalidated);
        });
...
(function (cornerstone) {
    ...
    function getRenderCanvas(enabledElement, layer, image, invalidated)
    {
        ...
        if(layer.viewport.voi.windowWidth === enabledElement.image.windowWidth &&
            layer.viewport.voi.windowCenter === enabledElement.image.windowCenter &&
...
(function (cornerstone) {
    ...
    function renderWebImage(enabledElement, invalidated) {
        ...
        if(baseLayer.viewport.voi.windowWidth === enabledElement.image.windowWidth &&
            baseLayer.viewport.voi.windowCenter === enabledElement.image.windowCenter &&
